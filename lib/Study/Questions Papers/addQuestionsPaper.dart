...
class addQuestionsPaper extends StatefulWidget {
  const addQuestionsPaper({Key? key}) : super(key: key);

  @override
  State<addQuestionsPaper> createState() => _addQuestionsPaperState();
}

class _addQuestionsPaperState extends State<addQuestionsPaper> {
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: const Text('Add Questions Paper'),
        ),
        body: ListView(
          children: [
            Padding(
            ...
            ElevatedButton(
              onPressed: () async {
                ...
                currentFocus.unfocus();
                final docVideo =
                FirebaseFirestore.instance.collection('$value QP').doc();
                final newFile = video(
                    id: docVideo.id,
